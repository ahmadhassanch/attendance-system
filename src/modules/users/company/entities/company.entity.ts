...
export class CompanyEntity {
  @ApiProperty({
    required: true,
    example: 'companyId',
    description: 'The companyId of the Company',
  })
  @IsString()
  companyId: string;
  ...
  @ApiProperty({
    required: false,
    example: false,
    description: 'The isDeleted of the Company',
  })
  @IsOptional()
  @IsBoolean()
  isDeleted?: boolean;
  ...
  @ApiProperty({
    required: true,
    description: 'The dateCreated of the Company',
  })
  @IsInt()
  dateCreated: bigint;
  ...
  @ApiProperty({
    required: true,
    description: 'The dateUpdated of the Company',
  })
  @IsInt()
  dateUpdated: bigint;
}
